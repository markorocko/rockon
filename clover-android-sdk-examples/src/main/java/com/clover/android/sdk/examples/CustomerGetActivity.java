...
public class CustomerGetActivity extends Activity {
  ...
  private static int addedCustomers=0;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_customer_get);
    ...
    new AsyncTask<Void, Void, List<String>>() {
      ...
      protected List<String> doInBackground(Void... params) {
        try {
          ...
          if(addedCustomers==0) {
              output.add("Creating customer ->");
              Customer newCustomer = customerConnector.createCustomer("Lewis", "Huey", false);
              output.add(customerToOutput(newCustomer));
          }
          else if(addedCustomers==1) {
            output.add("Yep, more? \nCreating customer ->");
            Customer newCustomer = customerConnector.createCustomer("Jackson", "Michael", false);
            output.add(customerToOutput(newCustomer));
          }
          else if(addedCustomers==2) {
            output.add("Yep, more? \nCreating customer ->");
            Customer newCustomer = customerConnector.createCustomer("George", "Boy", false);
            output.add(customerToOutput(newCustomer));
          }
          addedCustomers++;
